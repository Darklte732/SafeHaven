      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <Link href="/" className="flex items-center space-x-2">
              <Image src="/logo.svg" alt="SafeHaven Logo" width={32} height={32} />
              <span className="text-xl font-bold text-white">SafeHaven</span>
            </Link>
            <p className="text-sm">
              Protecting families with affordable final expense insurance solutions.
            </p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm">
              © {new Date().getFullYear()} SafeHaven Insurance. All rights reserved.
            </p>
            <div className="flex space-x-6">
              ...
              <Link href="/licensing" className="text-sm hover:text-white">
                Licensing
              </Link>
            </div>
          </div>
