            ...
            <Dialog open={isPreviewOpen} onOpenChange={setIsPreviewOpen}>
              ...
              <DialogContent className="max-w-3xl bg-white">
                <DialogHeader className="border-b pb-4">
                  <DialogTitle className="text-xl text-gray-900">Guide Preview</DialogTitle>
                ...
                <div className="mt-6 space-y-6 text-gray-700 bg-white">
                  <div className="prose prose-blue max-w-none">
                    ...
                    <div className="text-center mt-8 pt-6 border-t">
                      <p className="text-sm text-gray-600 mb-4">This is just a preview. Download the full guide to learn more about:</p>
